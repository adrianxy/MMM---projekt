...
class MainWindow(tkinter.Tk):
    ...
    def create_window(self):
        ...
        signal_parameters = {  # Parametry sygnału
            ...
            'triangle': ('Amplituda', 'Offset', 'Okres', 'Opóźnienie'),
        ...
        def run_simulation(*args):
            ...
            if exceptions_caught:
                ...
                try:
                    ...
                    self._exception_displayer.add_message(e.__str__())
                    self._exception_displayer.display_error_message()
        ...
        tkinter.Label(signal_type_frame, text="Typ sygnału:").grid(column=0, columnspan=2, row=0, sticky="n")
